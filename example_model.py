#!/usr/bin/env python
"""
Example clogistic regression classifier.
...
def main():
    ...
    train = pd.read_csv('training_data.csv', header=0)
    # The tournament data is the data that Numerai uses to evaluate your model.
    tournament = pd.read_csv('tournament_data.csv', header=0)
    ...
    # Your goal is to find the best that can minimize the loss without knowing what the features mean
